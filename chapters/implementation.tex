...
\includepdf[pages={1-},scale=0.25,width=1.5\textwidth,pagecommand={}\label{tab:dse-table}]{../pdf/results.pdf}
...
\subsection{Output Switch Matrix Optimizations}\label{sec:osm}
